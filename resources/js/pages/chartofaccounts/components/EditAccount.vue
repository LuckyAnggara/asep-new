...
const onSubmit = () => {
    router.visit(route('chart-of-accounts.update', data.value.id), {
        ...
        onSuccess: () => {
            ...
            form.reset(['code', 'name', 'description', 'sub_category_id']);
                ...
                <form class="flex flex-col space-y-4">
                    <div class="grid gap-2">
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-400"
                            >Otomatis oleh sistem</span
                        >
                    </div>
                    <div class="grid gap-2">
                        <Label for="email">Sub Kategori</Label>
                        <Select v-model="data.sub_category_id">
                            <SelectTrigger>
                                <SelectValue
