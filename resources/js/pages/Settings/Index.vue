...
const allowedTypes = [
    ...
    'image/svg+xml',
    'image/bmp',
]; // Semua tipe gambar yang didukung
...
const handleFileUpload = (event) => {
    ...
    if (!allowedTypes.includes(selectedFile.type)) {
        ...
        toast({
            title: 'Error',
            description:
                'Unsupported file type. Allowed types: JPEG, PNG, GIF, WEBP, SVG, BMP.',
            variant: 'destructive',
        });
        event.target.value = null; // Reset input
        return;
                ...
                <TabsContent value="company" class="my-6">
                    ...
                    <form @submit.prevent="submitCompany" class="">
                        <div class="mb-6 flex flex-row space-x-4">
                            ...
                            />
                            <div
                                class="w-full space-y-4 place-self-start lg:w-1/3"
                            >
                                <div class="flex flex-row space-x-4">
                                    <img
                                        :src="getLogoImage()"
                                        alt="Image"
                                        class="h-60 w-60 object-cover dark:brightness-[0.7]"
                                    />
                                    <Trash2
                                        v-if="previewImage"
                    ...
                    <form @submit.prevent="submitPreferences">
                        <div class="mb-6 grid w-full gap-4 lg:w-1/3">
                            ...
                            <div>
                                ...
                                <Select
                                    id="currency"
                                    v-model="formPreferences.currency"
                                >
                                    <SelectTrigger>
                                        <SelectValue
                            ...
                            <div>
                                ...
                                <Select
                                    id="timezone"
                                    v-model="formPreferences.timezone"
                                >
                                    <SelectTrigger>
                                        <SelectValue
                        ...
                        <div class="mt-6">
                            <Button
                                type="submit"
                                :disabled="formPreferences.processing"
                            >
                                <span
                                    v-if="formPreferences.processing"
                                    class="flex"
                                >
                                    <ReloadIcon
                                        class="mr-2 h-4 w-4 animate-spin"
                ...
                <TabsContent value="security" class="my-6">
                    ...
                    <form @submit.prevent="updatePassword">
                        <div class="mb-6 grid w-full gap-4 lg:w-1/3">
                            <div>
                                ...
                                <Input
                                    type="password"
                                    id="current_password"
                                    v-model="formSecurity.current_password"
                                    required
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <Input
                                    type="password"
                                    id="new_password"
                                    v-model="formSecurity.new_password"
                                    required
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    id="confirm_password"
                                    v-model="
                                        formSecurity.new_password_confirmation
                                    "
                                    required
                                />
                            </div>
                        ...
                        <div class="mt-6">
                            <Button
                                type="submit"
                                :disabled="formSecurity.processing"
                            >
                                <span
                                    v-if="formSecurity.processing"
                                    class="flex"
                                >
                                    <ReloadIcon
                                        class="mr-2 h-4 w-4 animate-spin"
